...
Smoke test:
    ...
    python -m agents.transformer_v2.runner --smoke-test \\
        --ckpt data/runs/pair_score/<run>/pair_score_best.pt

Plug into UI / runner:

    from agents.transformer_v2 import runner   # registers `transformer_v2`
    Agent("transformer_v2")                     # via agents.registry
        ...
        *,
        ...
        if "pair_score_head" not in ckpt:
            raise ValueError(
                ...
                "output of agents/transformer_v2/pretrain/pair_score.py."
            )
...
# imports this module twice (once as ``agents.transformer_v2.runner``
...
def main() -> None:
    ...
    if args.smoke_test:
        ...
        return
    print("transformer_v2 registered. Use:")
    print("  from agents.registry import Agent")
    print("  Agent('transformer_v2')(obs)")
