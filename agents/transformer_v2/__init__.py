# transformer_v2 — action-decoder agent (freeze-trained imitation policy
# + physical_v4 launch helper). Design lives in DESIGN.md. Importing
# ``runner`` triggers the ``@register("transformer_v2", ...)`` decorator
# so ``Agent("transformer_v2")`` resolves once this package is imported.
